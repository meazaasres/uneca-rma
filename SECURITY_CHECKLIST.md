...
- CSV imports enforce row and column limits, reject prototype-pollution property names, cap cell lengths, and copy only validated fields into point or matched country-polygon features.
